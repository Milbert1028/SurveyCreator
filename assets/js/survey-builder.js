    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            ...
            <div class="card shadow-sm animate__animated animate__fadeInRight" style="animation-delay: 0.3s">
                <div class="card-header bg-white p-3">
                    <h5 class="mb-0"><i class="fas fa-cog me-2 text-info"></i> Survey Settings</h5>
                </div>
                <div class="card-body">
                    <div class="mb-3">
                        <label for="survey-status" class="form-label">Status</label>
                        <select class="form-select" id="survey-status" name="status">
                            <option value="draft" <?php echo $survey_data['status'] === 'draft' ? 'selected' : ''; ?>>Draft</option>
                            <option value="published" <?php echo $survey_data['status'] === 'published' ? 'selected' : ''; ?>>Published</option>
                            <option value="closed" <?php echo $survey_data['status'] === 'closed' ? 'selected' : ''; ?>>Closed</option>
                        </select>
                    </div>
                    
                    <div class="d-grid gap-2 mt-4">
                        <a href="<?php echo SITE_URL; ?>/dashboard/view-surveys.php" class="btn btn-outline-secondary">
...
<script>
// Main initialization - clean implementation with no duplicate event listeners
